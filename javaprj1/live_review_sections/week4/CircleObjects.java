...
public class CircleObjects {
	...
	public static void main(String[] args) {
		...
		// We want to print newly created object with its attributed + behaviours.
		...
		// Outcome: Radius 0.0, Area: 0.0, Peremeter: 0.0    ==> provided default values: 0.0
		// toString() method is added to class without method name modification.
		
		System.out.println(circle1.toString()); // still, emthod has to be defined in class in order to use it here.
