...
public class ArrayCreation {
	...
	public static void main(String[] args) {
		...
		scores[3] = 100;
		scores[4] = 85;
//		scores[5] = 35; // error: out of bound
		...
		System.out.println(numbers[2]); //default value for integer
		System.out.println(temp[82]);   //default value for float
		System.out.println(words[4]);   //default value for String
//		System.out.println(units[50]);  //error: out of bound
