...
public class task80_positionIndex {
	
	public static void main(String[] args) {
		
		/*

		Write a method that accepts 2 strings(str1,str2)  and prints the position index of the str2 if str2 is existing in str1.
